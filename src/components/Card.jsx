      ...
      <div class="card p-4 bg-white">
        <div class={`card-body-${props.type}`}>
          ...
          <Link to={`/challengeExam/${props.id}`} onClick={() => window.scrollTo(0, 0)}>
              {completed ? <button href="#" className="stretched-link btn btn-primary mb-3">Practice Now</button> : 
              <button href="#" className="stretched-link btn btn-primary mb-3">Practice Again</button>}
          </Link>
        </div>
      </div>
    </div>
